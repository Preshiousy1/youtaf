          ...
          @if(count($posts) == 1)
            <div class="col-lg-6">
              <div>
                ...
                <p class="text-muted mb-3 text-uppercase small"><span class="mr-2">{{$posts[0]->created_at}} </span> By <span  class="by">{{$posts[0]->user->name}}</span></p>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div>
                  ...
                  <p class="text-muted mb-3 text-uppercase small"><span class="mr-2">{{$posts[1]->created_at}} </span> By <span class="by">{{$posts[1]->user->name}}</span></p>
